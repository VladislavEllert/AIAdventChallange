...
| 04 | 15 | Контролируемые переходы: рой 3 агентов (PLANNING) + Оркестратор-надсмотрщик на всех стадиях, именованные сессии SQLite с персистом, `/session` команды, `/task jump` FSM-демо | done | [agent-cli](../agent-cli/) | — |
