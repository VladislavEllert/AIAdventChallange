...
| 02 | 07 | Сохранение контекста: SQLite (SwiftData) + слоистая память — долгие факты между сессиями, сжатие в summary, JSON-экспорт | done | [week-02/day-07](../week-02/day-07/) · [AgentChat](../AgentChat/) | _TODO_ |
